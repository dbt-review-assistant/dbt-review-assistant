"""Check if the seed column names match between the manifest and the catalog."""
...
class SeedColumnNamesMatchManifestVsCatalog(ManifestVsCatalogComparison):
    """Check if the seed column names match between the manifest and the catalog.
    ...
    check_name: str = "seed-column-names-match-manifest-vs-catalog"
